...
local mainMessage = [[
	...
	As if v9.8.22 the kit will set SoundService.RespectFilteringEnabled to false to reduce lag.
...
nextbtn.MouseButton1Click:Connect(function()
	game.SoundService.RespectFilteringEnabled = false --Make sure that this running from the command line not a script
	if models then
		...
		if #instruments ~= 0 or not game.ServerStorage:FindFirstOfClass("Tool") then --Check for the Instruments scripts.
			...
			print("Source Building Coming Soon")
